    ...
    if Q[1] < yd:
        ...
        if xl <= x and x <= xr:
            if i == 1:
                ...
                r2[0] = x
                r2[1] = yd
            return A(FL, i, Q, p1, p2, r1, r2, xl, xr, yd, yu) # проверка пересения с нижним краем
    ...
    if Q[1] > yu:
        ...
        if xl <= x and x <= xr:
            if i == 1:
                ...
                r2[0] = x
                r2[1] = yu
            return A(FL, i, Q, p1, p2, r1, r2, xl, xr, yd, yu) # проверка пересечения с верхним краем
    ...
    if Q[0] < xl:
        ...
        if yd <= y and y <= yu:
            if i == 1:
                ...
                r2[0] = xl
                r2[1] = y
            return A(FL, i, Q, p1, p2, r1, r2, xl, xr, yd, yu) # проверка пересечения с левым краем
    ...
    if Q[0] > xr:
        ...
        if yd <= y and y <= yu:
            if i == 1:
                ...
                r2[0] = xr
                r2[1] = y
            return A(FL, i, Q, p1, p2, r1, r2, xl, xr, yd, yu) # проверка пересечения с правым крааем
